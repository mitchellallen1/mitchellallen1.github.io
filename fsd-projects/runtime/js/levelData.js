    ...
    var levelData = [
      {
        ...
        gameItems: [
          ...
          { type: "obstacle", x: 900, y: groundY - 110, damage: 20, rotation: 0, size: 25, image: "img/newMissile.png", offsetX: -35, offsetY: -35, scaleX: 0.35, scaleY: 0.35},
          ...
          { type: "enemy", x: 900, y: groundY - 50, hitZoneSize: 40, image: "img/newNBrio.png", offsetX: -80, offsetY: -150, scaleX: 0.25, scaleY: 0.25, speed: 3, damage: 20, score: 200},
          { type: "enemy", x: 1400, y: groundY - 50, hitZoneSize: 25, image: "img/newNeoCortex.png", offsetX: -25, offsetY: -25, scaleX: 0.25, scaleY: 0.25, speed: 3, damage: 25, score: 500},
          { type: "enemy", x: 1900, y: groundY - 50, hitZoneSize: 25, image: "img/spikes.png", offsetX: -25, offsetY: -25, scaleX: 0.25, scaleY: 0.25, speed: 3, damage: 10, score: 1000},
